...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --arch=arm --enable-version3 --enable-gpl --enable-small --disable-armvfp --disable-stripping --disable-ffmpeg --disable-ffplay --disable-ffserver --disable-ffprobe --disable-decoders --disable-encoders --disable-muxers --disable-demuxers --disable-devices --disable-protocols --disable-parsers --disable-filters --disable-bsfs --disable-network --disable-mpegaudio-hp --disable-avdevice --enable-cross-compile --cc=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc --cross-prefix=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi- --nm=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-nm --disable-asm --enable-armv5te --enable-libmp3lame --enable-encoder=libmp3lame --extra-cflags='-fPIC -DANDROID -I../ -I/home/dario/android-ndk-r4b/build/platforms/android-3/arch-arm/usr/include/' --extra-ldflags='-Wl,-T,/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/home/dario/android-ndk-r4b/build/platforms/android-3/arch-arm/usr/lib -L/home/dario/android-ndk-r4b/build/platforms/android-3/arch-arm/usr/lib -L../../libs/armeabi -nostdlib /home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl'
prefix=/usr/local
...
SRC_PATH="/home/dario/flipzu/mobile/android/jni/ffmpeg"
SRC_PATH_BARE=/home/dario/flipzu/mobile/android/jni/ffmpeg
BUILD_ROOT="/home/dario/flipzu/mobile/android/jni/ffmpeg"
ARCH=c
CC=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
AS=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
LD=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
DEPCC=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-gcc
YASM=yasm
YASMDEP=yasm
AR=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ar
RANLIB=/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/bin/arm-eabi-ranlib
CP=cp -p
LN_S=ln -sf
STRIP=echo skipping strip
CPPFLAGS= -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
CFLAGS= -fPIC -DANDROID -I../ -I/home/dario/android-ndk-r4b/build/platforms/android-3/arch-arm/usr/include/  -std=c99 -fomit-frame-pointer -fPIC -marm -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes
ASFLAGS= -fPIC -DANDROID -I../ -I/home/dario/android-ndk-r4b/build/platforms/android-3/arch-arm/usr/include/  -fPIC -g
CC_O=-o $@
LDFLAGS=  -Wl,-T,/home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/arm-eabi/lib/ldscripts/armelf.x -Wl,-rpath-link=/home/dario/android-ndk-r4b/build/platforms/android-3/arch-arm/usr/lib -L/home/dario/android-ndk-r4b/build/platforms/android-3/arch-arm/usr/lib -L../../libs/armeabi -nostdlib /home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtbegin.o /home/dario/android-ndk-r4b/build/prebuilt/linux-x86/arm-eabi-4.4.0/lib/gcc/arm-eabi/4.4.0/crtend.o -lc -lm -ldl -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
